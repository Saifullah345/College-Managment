...
// import GroupIcon from '@mui/icons-material/Group'; // Import GroupIcon for students
  ...
  return (
    <>
      <React.Fragment>
        ...
        <ListItemButton component={Link} to="/Admin/AccountStatement">
          <ListItemIcon>
            <ClassOutlinedIcon
              color={
                location.pathname.startsWith("/Admin/AccountStatement")
                  ? "primary"
                  : "inherit"
              }
            />
        ...
        {/* Add more student-related functionalities here */}
        {/* Define the route for General Settings */}
        <ListItemButton component={Link} to="/AddAddress">
          <ListItemIcon>
            <SettingsIcon
              color={
                location.pathname.startsWith("/Admin/generalSitting")
                  ? "primary"
                  : "inherit"
              }
            />{" "}
